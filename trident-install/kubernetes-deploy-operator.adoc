...
You can now create the `TridentOrchestrator` and install Trident. Optionally, you can link:../trident-install/kubernetes-customize-deploy.html[customize your Trident installation] using the attributes in the `TridentOrchestrator` spec.
