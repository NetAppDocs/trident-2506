...
Using the `tridentctl` utility, you can run the `get` command to get subordinate volumes. For more information, refer to link:../trident-managing-k8s/tridentctl.html[`tridentctl` commands and options].
...
* Visit link:https://www.netapp.com/google-cloud/netapp-volumes/[Sharing volumes between namespaces: Say hello to cross-namespace volume access^].
