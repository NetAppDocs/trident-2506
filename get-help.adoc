...
NOTE: For the latest Trident version support schedule, refer to the https://docs.netapp.com/us-en/trident/get-help.html#trident-support-lifecycle[Support lifecycle page^].
...
* link:https://www.netapp.com/google-cloud/netapp-volumes/[Kubernetes Hub^]